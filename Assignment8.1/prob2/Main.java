...
public class Main {
	...
	public static void main(String[] args) {
		...
		List<? extends EmployeeData> combined = combine(staff, teachers);
	...
	//IMPLEMENT
	public static List<? extends EmployeeData>/*<specify type>*/ combine(List<Staff> staff, List<Teacher> teachers) {
